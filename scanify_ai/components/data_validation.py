from scanify_ai.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
...
import pandas as pd
import os,sys
from  scanify_ai.utils.main_utils.utils import read_yaml_file,write_yaml_file
from scanify_ai.constant import training_pipeline
...
class DataValidation:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            trained_data_frame=DataValidation.read_data(train_file_path)
            test_data_frame=DataValidation.read_data(test_file_path)
            
            status=self.validate_number_of_columns(dataframe=trained_data_frame)
            if not status:
            ...
            status=self.detect_dataset_drift(base_df=trained_data_frame,current_df=test_data_frame)
            dir_path=os.path.dirname(self.data_validation_config.valid_train_file_path)
            os.makedirs(dir_path,exist_ok=True)

            trained_data_frame.to_csv(
