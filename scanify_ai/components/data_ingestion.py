...
from scanify_ai.entity.config_entity import DataIngestionConfig
from scanify_ai.entity.artifact_entity import DataIngestionArtifact
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
      try:
        if dataframe.empty:
            raise CustomException("No data found in MongoDB collection. Cannot split empty dataset.", sys)
