...
from scanify_ai.entity.config_entity import(
...
from scanify_ai.entity.artifact_entity import (
    DataIngestionArtifact,
    DataValidationArtifact,
    DataTransformationArtifact,
    ModelTrainerArtifact,
)
from scanify_ai.constant.training_pipeline import TRAINING_BUCKET_NAME
# from scanify_ai.cloud.s3_syncer import S3Sync
from scanify_ai.constant.training_pipeline import SAVED_MODEL_DIR
